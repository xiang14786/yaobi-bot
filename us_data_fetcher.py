...
SP500_TOP_STOCKS: list[str] = [
    ...
    # 軟體 & 雲端
    "CRM", "ORCL", "ADBE", "NOW", "INTU", "PANW", "FTNT",
    "PLTR", "UBER", "ABNB", "SNOW", "DDOG", "ZS", "CRWD",
    # 金融
    "JPM", "BAC", "WFC", "GS", "MS", "C", "BLK", "SCHW",
    "AXP", "V", "MA", "PYPL", "COF", "KKR", "APO",
    # 醫療 & 生技
    "UNH", "JNJ", "ABBV", "LLY", "MRK", "PFE", "AMGN",
    "GILD", "VRTX", "REGN", "ISRG", "MDT", "SYK", "BSX",
    # 消費 & 零售
    "WMT", "COST", "HD", "TGT", "NKE", "MCD",
    "SBUX", "LOW", "TJX", "LULU", "BKNG",
    # 能源 & 工業
    "XOM", "CVX", "LIN", "CAT", "HON", "GE", "BA", "LMT",
    "RTX", "UPS", "DE", "ETN", "NOC", "GEV",
    # 電信 & 媒體
    "NFLX", "DIS", "CMCSA", "T", "VZ", "TMUS", "SPOT",
    # 其他大型
    "BRK-B", "PG", "KO", "PEP", "PM", "MO", "SO", "NEE",
    "SPGI", "CME", "ICE", "COIN", "APP",
]
